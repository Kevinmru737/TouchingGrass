...
var dialogue = {
	...
	"feed_the_fish_success": ["I've found the rations, Captain.",
		"*shakes the fish food into his bowl*",
		"...there we go.",
		"That should make you feel better.",
		"Huh...?",
		"He spit out a battery...",
		"I guess he was getting desperate."],
	...
	"sort_books_fail": ["...I-I don't think I have it in me to deal with that right now.",
	...
	"...but I did it.",
	"I did the small things. One at a time.", "I made my bed.", "I fed Captain Tubbie.", 
	"I cleaned up my books.","I cleaned up the trash.", "...",
	"It wasn't much but weirdly... that feels like enough to open the door today.",
